...
while(1):
    escolha = int(input('Você deseja 1 - criptografar, 2- Descriptografar ou 3 - Sair\n'))
    if escolha == 1:
        ...
        palavra_chave = input('Insira sua chave para descriptografar(Deve conter apenas letras sem espaço):\n').lower()
        resultado = verificar_apenas_letra(palavra_chave)
        if resultado:
            palavra_descriptografar = input('Insira uma palavra para ser descriptografada:\n').lower()
            resultado = verificar_apenas_letra(palavra_descriptografar)
            if resultado:
                palavra_descriptografada = descriptografar(palavra_chave, palavra_descriptografar)
